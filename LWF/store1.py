...
class store:
                    ...
                    results.append(
                        {
                            "title": title,
                            "price": mony,
                            "link": "https://online.carrefour.com.tw" + href,
                            "pic": img,
                        }
                    )
                    time.sleep(1)
                    ...
                    results.append(
                        {
                            "title": title,
                            "price": mony,
                            "link": "https://www.poyabuy.com.tw" + href,
                            "pic": "https:" + img,
                        }
                    )
                    time.sleep(1)
    ...
    def momo(self, product, results):
        ...
        for i in range(1, 2):
            # print(f'第{i}頁')
            self.browser.get(
                f"https://www.momoshop.com.tw/search/searchShop.jsp?keyword={product}&searchType=1&cateLevel=0&cateCode=&curPage={i}&_isFuzzy=0&showType=chessboardType&isBrandCategory=N&serviceCode=MT01"
            )
            ...
            for li in lis:
                ...
                if check == True:
                    ...
                    results.append(
                        {"title": title, "price": price, "link": link, "pic": pic}
                    )
                    # print("momo")
                    time.sleep(1)
            self.save_results(results, product)
